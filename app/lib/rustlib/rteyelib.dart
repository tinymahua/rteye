...
class RteyeLibNativeLibrary {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  RteyeLibNativeLibrary(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RteyeLibNativeLibrary.fromLookup(
  ...
  ffi.Pointer<ffi.Char> get_net_stat() {
    return _get_net_stat();
  }

  late final _get_net_statPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'get_net_stat');
  late final _get_net_stat =
      _get_net_statPtr.asFunction<ffi.Pointer<ffi.Char> Function()>();
}
